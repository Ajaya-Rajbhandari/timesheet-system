...
// Update the fetchAllSchedules function
export const fetchAllSchedules = async () => {
  try {
    const response = await axios.get("/schedules"); // Should be "/api/schedules"
...
export const fetchDepartmentSchedules = async (
  department,
  startDate,
  endDate,
) => {
  ...
  try {
    ...
    throw (
      error.response?.data?.message || "Error fetching department schedules"
    );
  }
};

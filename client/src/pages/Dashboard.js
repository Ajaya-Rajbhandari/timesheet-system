              ...
              <CardContent>
                <Stack spacing={3}>
                  ...
                  <Box sx={{ textAlign: 'center' }}>
                    <Chip
                      icon={<ClockIcon />}
                      label={attendanceStatus.isClockedIn ? 'Clocked In' : 'Clocked Out'}
                      color={attendanceStatus.isClockedIn ? 'success' : 'default'}
                      sx={{ 
                        fontSize: '1rem',
                        py: 3,
                        px: 4,
                    ...
                    {attendanceStatus.clockInTime && (
                      <Typography variant="body2" sx={{ mt: 2, color: 'text.secondary' }}>
                        Since {moment(attendanceStatus.clockInTime).format('hh:mm A')}
                      </Typography>
                    )}
                  </Box>
                </Stack>
                ...
                <Stack spacing={3}>
                  ...
                  {schedules.length > 0 ? (
                    <Box sx={{ textAlign: 'center' }}>
                      ...
                      <Chip
                        icon={<WorkIcon />}
                        label={schedules[0].type.charAt(0).toUpperCase() + schedules[0].type.slice(1)}
                        color={
                          schedules[0].type === 'regular' ? 'primary' :
                          schedules[0].type === 'overtime' ? 'error' :
                          schedules[0].type === 'flexible' ? 'warning' : 'success'
                        }
                        sx={{ borderRadius: 2 }}
                      />
                      {schedules[0].notes && (

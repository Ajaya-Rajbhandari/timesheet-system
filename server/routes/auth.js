  ...
  try {
    ...
    try {
      ...
      if (process.env.SMTP_HOST && process.env.SMTP_PORT) {
        ...
        console.log('SMTP not configured. Would send email with reset link:', resetUrl);
        return res.status(200).json({ 
          message: 'Password reset link generated. In development mode, check server logs for the reset link.' 
        });
      }
